# allocate elastic ip. this eip will be used for the nat-gateway in the public subnet az1 / allow all communication to between our application and this has 
# has to be done in public subnet, it will route network to our pravite subnet
